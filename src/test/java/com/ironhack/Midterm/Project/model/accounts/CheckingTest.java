...
class CheckingTest {
    ...
    void setBalance_GoodBalance_Balance() {
        assertEquals(BigDecimal.valueOf(2000000), checking.getBalance().getBalance());
        checking.getBalance().setBalance(BigDecimal.valueOf(1244657));
        assertEquals("The balance has been set", checking.setBalance(checking.getBalance()));
    }
    @Test
    void setBalance_Balance_Penalty() {
        checking.getBalance().setBalance(BigDecimal.valueOf(150));
        assertEquals("A penalty has been taken from the balance", checking.setBalance(checking.getBalance()));
        assertEquals(BigDecimal.valueOf(110), checking.getBalance().getBalance());
    }
    ...
    void getBalance_LastActualizedDateLess1month(){
        ...
        assertEquals(BigDecimal.valueOf(19000), checking3.getBalance().getBalance());
    }
    @Test
    void getBalance_LastActualizedDateMore1month(){
        ...
        assertEquals(BigDecimal.valueOf(18988), checking5.getBalance(checking5.getLastActualizedDate()).getBalance());
        checking5.getBalance(checking5.getLastActualizedDate());
